...
function onMainReady()
{
  ...
  var dsc = [];
  if(imgs.index)
    var src =  encodeURI(imgs.index) 
    dsc.push("<a title=\"Back to index\" href=\"" + encodeURI(imgs.index) + "\"><img src=\"/imgfgal/back.png\"/></a>");
  ...
  if(imgs.download)
    dsc.push("<a title=\"Download album\" href=\"" + encodeURI(imgs.download) + "\"><img src=\"/imgfgal/download.png\"/></a>");
...
function initGallery(data)
{
  ...
  eleft.adopt((new Element('div')).adopt(new Element('img', { 'src': '/imgfgal/left.png' })));
  eleft.inject(econt);

  eright = new Element('a', { id: 'right' });
  eright.adopt((new Element('div')).adopt(new Element('img', { 'src': '/imgfgal/right.png' })));
  eright.inject(econt);
...
function init()
{
  ...
  Asset.images(['/imgfgal/throbber.gif',
		'/imgfgal/left.png', '/imgfgal/right.png',
		'/imgfgal/eye.png', '/imgfgal/download.png', '/imgfgal/back.png',
		'/imgfgal/cut-left.png', '/imgfgal/cut-right.png',
		'/imgfgal/cut-top.png', '/imgfgal/cut-mov.png']);
}
